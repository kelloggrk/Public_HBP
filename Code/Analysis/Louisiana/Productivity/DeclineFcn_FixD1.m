...
% Fix the value of d1 based on outside information

function [diff, jacob, prodComp] = DeclineFcn_FixD1(param,data,d1,tau,wellIDX,scaleVec)
    %% Compute Function
    ...
    if nargout > 1
        ...
        jacob = [jacobD2 jacobMmat] .* scaleVec';
