...
% Save plot
saveas(h,[dirs.figfinaldir,'EVlessorprofit_vs_priterm.pdf'])

% Beamer version
set(gca, 'FontName', 'Helvetica')
legend('Location','best')
saveas(h,[dirs.figbeamerdir,'EVlessorprofit_vs_priterm.pdf'])
...
set(h,'PaperPosition', [0 0 1 1]);
% Save plot
saveas(h,[dirs.figfinaldir,'EVtotal_vs_priterm.pdf'])

% Beamer version
set(gca, 'FontName', 'Helvetica')
saveas(h,[dirs.figbeamerdir,'EVtotal_vs_priterm.pdf'])
...
set(h,'PaperUnits','normalized');
set(h,'PaperPosition', [0 0 1 1]);
saveas(h,[dirs.figfinaldir,'Edrillingprobs_priterm.pdf'])

% Beamer version
set(gca, 'FontName', 'Helvetica')
saveas(h,[dirs.figbeamerdir,'Edrillingprobs_priterm.pdf'])
...
set(h,'PaperUnits','normalized');
set(h,'PaperPosition', [0 0 1 1]);
saveas(h,[dirs.figfinaldir,'Edrillinghaz_priterm.pdf'])

% Beamer version
set(gca, 'FontName', 'Helvetica')
saveas(h,[dirs.figbeamerdir,'Edrillinghaz_priterm.pdf'])
...
filenameo = strcat(dirs.figfinaldir,'varPriTerm.csv');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Save workspace
outfile = [dirs.outputdir,'varyPriTerm_SimResults'];   
save(outfile);
